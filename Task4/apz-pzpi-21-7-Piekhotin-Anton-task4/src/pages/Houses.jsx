...
function Houses() {
    ...
    async function fetchHouses() {
        let response = await axios.get('https://localhost:8080/api/v1/house/all', {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}});
    ...
    async function changeHouse(house) {
        try {
            const response = await axios.post(`https://localhost:8080/api/v1/house/edit/${house.id}`, house, {
                headers: {
